...
if (CON.LANG == 'HI') ADMİN_USER = '*පරිපාලක ගණන:*', USER_USER = '*සාමාජික ගණන:*', TR_USER = '*තුර්කි සාමාජික ගණන:*', Hİ_USER = '*ඉන්දියානු සාමාජික ගණන:*', AZ_USER = '*අසර්බජන් සාමාජිකයින් ගණන:*', SRİ_USER = '*ශ්‍රී ලංකා සාමාජිකයින් ගණන:*', RU_USER = '*රුසියන් සාමාජිකයින් ගණන:*', USA_USER = '*USA සාමාජිකයින් ගණන:*', OTHER = '*වෙනත් රටවල සාමාජිකයින්:*'
